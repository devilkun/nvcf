...
// StorageRequests returns a StorageRequestInformer.
func (v *version) StorageRequests() StorageRequestInformer {
	return &storageRequestInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
