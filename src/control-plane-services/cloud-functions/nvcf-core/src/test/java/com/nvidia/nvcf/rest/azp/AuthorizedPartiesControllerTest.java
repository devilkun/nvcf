...
class AuthorizedPartiesControllerTest {
    ...
    Stream<Arguments> authorizedPartiesAllVersionsArgs() {
        ...
        var apiKeyCases = Stream.of(
                // Resource allows operating on any function in TEST_NCA_ID account.
                // Operate on TEST_FUNCTION_ID in TEST_NCA_ID account.
                Arguments.of((Supplier<String>) () -> {
                             ...
                             HttpStatus.OK),
                // Resource allows operating on any function in TEST_NCA_ID account.
                // Attempt to operate on a non-existent function.
                Arguments.of((Supplier<String>) () -> {
                                 setResponse(TEST_NCA_ID, TEST_OWNER_ID,
                                             List.of(new Resource("account-functions", "*")),
                                             List.of(SCOPE_AUTHORIZE_CLIENTS));
                             ...
                             TEST_FUNCTION_ID_2,
                             HttpStatus.NOT_FOUND),
                // Resource allows operating only on TEST_FUNCTION_ID in TEST_NCA_ID account.
                Arguments.of((Supplier<String>) () -> {
                                 setResponse(TEST_NCA_ID, TEST_OWNER_ID,
                             ...
                             TEST_FUNCTION_ID,
                             HttpStatus.OK),
                // apikey is for a non-existent account.
                Arguments.of((Supplier<String>) () -> {
                             ...
                             TEST_FUNCTION_ID,
                             HttpStatus.NOT_FOUND),
                // apikey is for TEST_NCA_ID_2 account but TEST_FUNCTION_ID is in TEST_NCA_ID account.
                Arguments.of((Supplier<String>) () -> {
                ...
                Arguments.of("nvapi-stg-some-key", TEST_FUNCTION_ID_2, HttpStatus.FORBIDDEN)
        );

        return Stream.concat(jwtCases, apiKeyCases);
    }

    Stream<Arguments> createAuthorizedPartiesAllVersionsArgs() {
        return Stream.of(
                // Resource allows operating on any function in TEST_NCA_ID account.
                // Operate on TEST_FUNCTION_ID_3 also defined in TEST_NCA_ID account.
                Arguments.of((Supplier<String>) () -> {
                                 setResponse(TEST_NCA_ID, TEST_OWNER_ID,
                                             List.of(new Resource("account-functions", "*")),
                                             List.of(SCOPE_AUTHORIZE_CLIENTS));
                             ...
                             HttpStatus.OK),
                // Resource allows operating only on TEST_FUNCTION_ID in TEST_NCA_ID account.
                // Attempting to operate on TEST_FUNCTION_ID_3 also in TEST_NCA_ID account.
                Arguments.of((Supplier<String>) () -> {
                                 setResponse(TEST_NCA_ID, TEST_OWNER_ID,
                                             List.of(new Resource("function",
                                                                  TEST_FUNCTION_ID + "/*")),
                             ...
                             TEST_FUNCTION_ID_3,
                             HttpStatus.FORBIDDEN),
                // Empty resource in the policy result.
                Arguments.of((Supplier<String>) () -> {
                                 setResponse(TEST_NCA_ID, TEST_OWNER_ID,
                                             List.of(),
                                             List.of(SCOPE_AUTHORIZE_CLIENTS));
    ...
    @ParameterizedTest
    @MethodSource({"authorizedPartiesAllVersionsArgs", "createAuthorizedPartiesAllVersionsArgs"})
    void createAuthorizedParties(
            Object tokenSupplier, UUID functionId, HttpStatus expectedStatus) {
        ...
        var requestEntity =
                RequestEntity
                        .post(URI.create("/v2/nvcf/authorizations/functions/" + functionId))
    ...
    Stream<Arguments> deleteAuthorizedPartiesAllVersionsArgs() {
        return Stream.of(
                // Resource allows operating on any function in TEST_NCA_ID account.
                // Operate on non-existent function in TEST_NCA_ID account.
                Arguments.of((Supplier<String>) () -> {
                                 setResponse(TEST_NCA_ID, TEST_OWNER_ID,
                                             List.of(new Resource("account-functions", "*")),
                                             List.of(SCOPE_AUTHORIZE_CLIENTS));
                             ...
                             UUID.randomUUID(),
                             HttpStatus.NOT_FOUND),
                // Resource allows operating only on versions of TEST_FUNCTION_ID in TEST_NCA_ID
                // account. Attempting to operate on TEST_FUNCTION_ID_3 also in TEST_NCA_ID account.
                Arguments.of((Supplier<String>) () -> {
                                 setResponse(TEST_NCA_ID, TEST_OWNER_ID,
                                             List.of(new Resource("function",
                                                                  TEST_FUNCTION_ID + "/*")),
    ...
    @ParameterizedTest
    @MethodSource({"authorizedPartiesAllVersionsArgs", "deleteAuthorizedPartiesAllVersionsArgs"})
    void deleteAuthorizedParties(
        ...
        testAuthPartiesService.associateAuthParties(TEST_NCA_ID, TEST_FUNCTION_ID, Optional.empty(),
                                                    authorizedParties);

        // Delete authorized parties for function.
        var requestEntity =
                RequestEntity
                        .delete(URI.create("/v2/nvcf/authorizations/functions/" + functionId))
                        .header("Authorization", "Bearer " + token)
                        .build();
        var responseEntity =
                testRestTemplate.exchange(requestEntity, AuthorizedPartiesResponse.class);
    ...
    Stream<Arguments> getAuthorizedPartiesAllVersionsArgs() {
        return Stream.of(
                // Resource allows operating on any function in TEST_NCA_ID account.
                // Operate on non-existent function in TEST_NCA_ID account.
                Arguments.of((Supplier<String>) () -> {
                ...
                // Resource allows operating only on versions of TEST_FUNCTION_ID in TEST_NCA_ID
                // account. Attempting to operate on TEST_FUNCTION_ID_3 also in TEST_NCA_ID account.
                // Should result in an empty list in the response.
                Arguments.of((Supplier<String>) () -> {
                                 setResponse(TEST_NCA_ID, TEST_OWNER_ID,
                                             List.of(new Resource("function",
                                                                  TEST_FUNCTION_ID + "/*")),
                             ...
                             TEST_FUNCTION_ID_3,
                             HttpStatus.OK),
                // Empty resource in the policy result should result in empty list in the response.
                Arguments.of((Supplier<String>) () -> {
                                 setResponse(TEST_NCA_ID, TEST_OWNER_ID,
                                             List.of(),
                                             List.of(SCOPE_AUTHORIZE_CLIENTS));
    ...
    @ParameterizedTest
    @MethodSource({"authorizedPartiesAllVersionsArgs", "getAuthorizedPartiesAllVersionsArgs"})
    void getAuthorizedParties(
        ...
        var requestEntity =
                RequestEntity
                        .get(URI.create("/v2/nvcf/authorizations/functions/" + functionId))
        ...
        assertThat(responseBody.functions().getFirst().authorizedParties()).isNotNull();
        var authParties1 = new HashSet<>(responseBody.functions().getFirst().authorizedParties());
        assertThat(authParties1)
                .hasSize(3)
                .containsExactlyInAnyOrderElementsOf(authorizedParties);

        assertThat(responseBody.functions().get(1).authorizedParties()).isNotNull();
        var authParties2 = new HashSet<>(responseBody.functions().get(1).authorizedParties());
                    ...
                    setResponse(TEST_NCA_ID, TEST_OWNER_ID,
                                List.of(new Resource("function",
                                        ...
                                        new Resource("function",
                                                     TEST_FUNCTION_ID + "/" + TEST_VERSION_ID_2),
                                        new Resource("function",
                                                     TEST_FUNCTION_ID + "/" + TEST_VERSION_ID_3)),
                                List.of(SCOPE_AUTHORIZE_CLIENTS));
                    return "nvapi-stg-some-key";
                })
        );
    ...
    void listAuthorizedPartiesForVersion(Object tokenSupplier) {
        ...
        var requestEntity =
                RequestEntity
                        .get(URI.create("/v2/nvcf/authorizations"
        ...
        var expectedAuthzAccounts1 = Set.of(TEST_AUTHORIZED_NCA_ID_1,
                                            TEST_AUTHORIZED_NCA_ID_2,
                                            TEST_AUTHORIZED_NCA_ID_5);
        var authzAccounts1 = responseBody.function()
                .authorizedParties()
                .stream()
                .map(AuthorizedPartyDto::ncaId)
                .collect(Collectors.toSet());
        assertThat(authzAccounts1).containsExactlyInAnyOrderElementsOf(expectedAuthzAccounts1);
        ...
        var expectedAuthzAccounts2 = Set.of(TEST_AUTHORIZED_NCA_ID_1,
                                           TEST_AUTHORIZED_NCA_ID_2,
                                           TEST_AUTHORIZED_NCA_ID_3,
                                           TEST_AUTHORIZED_NCA_ID_4,
                                           TEST_AUTHORIZED_NCA_ID_5);
        var authzAccounts2 = responseBody.function()
                .authorizedParties()
                .stream()
                .map(AuthorizedPartyDto::ncaId)
                .collect(Collectors.toSet());
        assertThat(authzAccounts2).containsExactlyInAnyOrderElementsOf(expectedAuthzAccounts2);
    }
    ...
    Stream<Arguments> authorizedPartiesForFunctionVersionArgs() {
        ...
        var apiKeyCases = Stream.of(
                ...
                Arguments.of((Supplier<String>) () -> {
                             ...
                             TEST_VERSION_ID_1,
                             HttpStatus.OK),
                // Resource allows operating only on TEST_FUNCTION_ID/TEST_VERSION_ID_1
                // in TEST_NCA_ID account.
                Arguments.of((Supplier<String>) () -> {
                                 setResponse(TEST_NCA_ID, TEST_OWNER_ID,
                                             List.of(new Resource("function",
                                                                  TEST_FUNCTION_ID + "/" +
                             ...
                             TEST_VERSION_ID_1,
                             HttpStatus.OK),
                // Resource allows operating only on TEST_FUNCTION_ID/TEST_VERSION_ID_1 in
                // TEST_NCA_ID account. Attempting to operate on TEST_FUNCTION_ID/TEST_VERSION_ID_2.
                Arguments.of((Supplier<String>) () -> {
                                 setResponse(TEST_NCA_ID, TEST_OWNER_ID,
                                             List.of(new Resource("function",
                                                                  TEST_FUNCTION_ID + "/" +
    ...
    void createAuthorizedPartiesForFunctionVersion(
        ...
        var requestEntity =
                RequestEntity
                        .post(URI.create("/v2/nvcf/authorizations"
        ...
        return Stream.of(
                ...
                Arguments.of(MOCK_OAUTH2_TOKEN_SERVER.getJwt(TEST_CLIENT_SUBJECT,
                             ...
                             testAuthPartiesService.authorizedParties(List.of(
                                     ImmutablePair.of(TEST_AUTHORIZED_CLIENT_ID_3, ""))),
                             HttpStatus.BAD_REQUEST),
                // Valid request object but only Super Admin can make a function public
                Arguments.of(MOCK_OAUTH2_TOKEN_SERVER.getJwt(TEST_CLIENT_SUBJECT,
                                                             List.of(SCOPE_AUTHORIZE_CLIENTS),
                                                             100),
                             TEST_FUNCTION_ID,
                             ...
                             HttpStatus.BAD_REQUEST),
                // Cannot specify clientId with wildcard account
                Arguments.of(MOCK_OAUTH2_TOKEN_SERVER.getJwt(TEST_CLIENT_SUBJECT,
                                                             List.of(SCOPE_AUTHORIZE_CLIENTS),
                                                             100),
                             TEST_FUNCTION_ID,
