...
import static com.nvidia.nvcf.util.NvcfConstants.ADMIN_SCOPE_MANAGE_REGISTRY_CREDENTIALS;
...
class XAccountRegistryCredentialManagementControllerTest {
    ...
    Stream<Arguments> getListRegistryCredentialsArgs() {
        return Stream.of(
                Arguments.of(null, null, TEST_NCA_ID, UNAUTHORIZED),
                Arguments.of("invalid-key", null, TEST_NCA_ID, UNAUTHORIZED),
                ...
                Arguments.of(MOCK_OAUTH2_TOKEN_SERVER.getJwt(TEST_ADMIN_SUBJECT,
                             ...
                             FORBIDDEN),
                Arguments.of(MOCK_OAUTH2_TOKEN_SERVER.getJwt(TEST_ADMIN_SUBJECT,
                                                             List.of(ADMIN_SCOPE_MANAGE_REGISTRY_CREDENTIALS),
                                                             100),
                             null,
                             TEST_NCA_ID,
                             OK),
    ...
    void shouldListRegistryCredentials(Object tokenSupplier, String artifactTypes, String ncaId,
        ...
        var builder = Strings.isBlank(artifactTypes) ?
                ...
                RequestEntity.get(
                        URI.create("/v2/nvcf/accounts/" + ncaId +
                                           "/registry-credentials?artifactType=" + artifactTypes));
        ...
        assertThat(responseBody.registryCredentials()).isNotNull();

        if (Strings.isBlank(artifactTypes)) {
            assertThat(responseBody.registryCredentials()).hasSize(3);
        } else {
        ...
        if (Strings.isBlank(artifactTypes) ||
            ...
            assertThat(helmRegistryCredential.provisionedBy())
                    .isEqualTo(ProvisionedByEnum.SYSTEM);
        }
        ...
        if (Strings.isBlank(artifactTypes) ||
            ...
            assertThat(resourceRegistryCredential.registryHostname())
                    .isEqualTo("api.stg.ngc.nvidia.com");
            assertThat(resourceRegistryCredential.artifactTypes()).contains(
    ...
    Stream<Arguments> getListFilteredRegistryCredentialsArgs() {
        return Stream.of(
                Arguments.of(null, null, null, TEST_NCA_ID, UNAUTHORIZED),
                Arguments.of("invalid-key", null, null, TEST_NCA_ID, UNAUTHORIZED),
                Arguments.of(MOCK_OAUTH2_TOKEN_SERVER.getJwt(TEST_ADMIN_SUBJECT,
                                                             List.of(), 100),
                             null,
                             null,
    ...
    void shouldListFilteredRegistryCredentials(
        ...
        var uri = "/v2/nvcf/accounts/" + ncaId + "/registry-credentials";
    ...
    Stream<Arguments> getAddRegistryCredentialsArgs() {
        ...
        return Stream.of(
                Arguments.of(null, validAddRegistryCredentialRequestsModel,
                             TEST_NCA_ID, UNAUTHORIZED),
                Arguments.of("invalid-key", validAddRegistryCredentialRequestsModel,
                             TEST_NCA_ID, UNAUTHORIZED),
                Arguments.of(MOCK_OAUTH2_TOKEN_SERVER.getJwt(TEST_ADMIN_SUBJECT,
                                                             List.of(), 100),
    ...
    void shouldAddRegistryCredential(
            Object tokenSupplier, AddRegistryCredentialRequest request, String ncaId,
            HttpStatus expectedStatus) {
        testAccountService.createDefaultAccountsClientsAndRegistries();
        var token = getToken(tokenSupplier);
        var builder = RequestEntity.post(URI.create(
                        "/v2/nvcf/accounts/" + ncaId + "/registry-credentials"))
    ...
    Stream<Arguments> getAddRegistryCredentialsWithInvalidRegionArgs() {
        ...
        var invalidEcrRegionAddRegistryCredentialRequestsContainer =
                AddRegistryCredentialRequest.builder()
                        ...
                        .secret(TestConstants.TEST_THIRD_PARTY_CONTAINER_SECRET_1)
                        .build();
        var invalidEcrRegionPrefixAddRegistryCredentialRequestsHelm =
                AddRegistryCredentialRequest.builder()
        ...
        return Stream.of(
                ...
                Arguments.of(invalidEcrRegionPrefixAddRegistryCredentialRequestsHelm),
                // VolcEngine registry with invalid region
    ...
    void shouldThrowBadRequestForAddRegistryCredentialsWithInvalidRegion(
        ...
        testAccountService.createDefaultAccountsClientsAndRegistries();
        var builder = RequestEntity.post(URI.create(
                        "/v2/nvcf/accounts/" + TEST_NCA_ID + "/registry-credentials"))
                .contentType(MediaType.APPLICATION_JSON)
    ...
    void shouldGetRegistryCredentialDetail(
            Object tokenSupplier, AddRegistryCredentialRequest addRegistryCredentialRequest,
            String ncaId,
            HttpStatus expectedStatus) {
        testAccountService.createDefaultAccountsClientsAndRegistries();
        var token = getToken(tokenSupplier);
        ...
        var builder = RequestEntity.get(
                URI.create(
                        "/v2/nvcf/accounts/" + ncaId +
                                "/registry-credentials/" + registryCredentialId));
        if (token != null) {
            builder = builder.header("Authorization", "Bearer " + token);
        }
        var requestEntity = builder.build();
    ...
    void shouldUpdateRegistryCredential(
        ...
        var credential =
                registryFunctionMapperService.toRegistryCredentialDto(
                        responseBody.registryCredential());
    ...
    void shouldGetRecognizedRegistries(
        ...
        testAccountService.createDefaultAccountsClientsAndRegistries();
        var token = getToken(tokenSupplier);
        var builder = RequestEntity.get(URI.create(
                "/v2/nvcf/accounts/" + ncaId + "/recognized-registries"));
        if (token != null) {
            builder = builder.header("Authorization", "Bearer " + token);
        }
        var requestEntity = builder.build();
        ...
        assertThat(response.recognizedRegistries()).isEqualTo(Map.of(
                ...
                List.of(Map.of("name", ECR_PRIVATE_REGISTRY_NAME,
                        ...
                        Map.of("name", NGC_PRIVATE_REGISTRY_NAME,
                               "hostname",
                               TEST_NGC_HELM_REGISTRY_CREDENTIAL.registryHostname()),
                        Map.of("name", VOLCENGINE_REGISTRY_NAME,
                               "hostname",
                               VOLCENGINE_REGISTRY_GLOBAL_HOSTNAME)),
