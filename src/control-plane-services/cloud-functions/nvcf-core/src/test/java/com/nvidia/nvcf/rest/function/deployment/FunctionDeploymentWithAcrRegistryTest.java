...
class FunctionDeploymentWithAcrRegistryTest {
    ...
    void beforeAll() {
        ...
        var addRegistryCredentialRequestForAcr = AddRegistryCredentialRequest.builder()
        ...
        registryCredentialService.addRegistryCredential(
                ...
                addRegistryCredentialRequestForAcr, ProvisionedByEnum.USER,
