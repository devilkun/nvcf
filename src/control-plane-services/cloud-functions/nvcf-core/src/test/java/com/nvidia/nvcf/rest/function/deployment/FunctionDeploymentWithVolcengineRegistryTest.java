...
import static com.nvidia.boot.mock.BootTestConstants.TEST_VOLCENGINE_CONTAINER_IMAGE_REPOSITORY_NOT_FOUND;
...
import static com.nvidia.boot.mock.BootTestConstants.TEST_VOLCENGINE_HELM_CHART_REPOSITORY_NOT_FOUND;
...
class FunctionDeploymentWithVolcengineRegistryTest {
    ...
    void beforeAll() {
        ...
        var addRegistryCredentialRequestForVolcengine = AddRegistryCredentialRequest.builder()
        ...
        registryCredentialService.addRegistryCredential(
                ...
                addRegistryCredentialRequestForVolcengine, ProvisionedByEnum.USER,
    ...
    Stream<Arguments> containerBasedFunctionDeploymentArgs() {
        return Stream.of(
                ...
                // volcengine image repository does not exist
                Arguments.of(TEST_VOLCENGINE_CONTAINER_IMAGE_REPOSITORY_NOT_FOUND,
    ...
    Stream<Arguments> helmBasedFunctionDeploymentArgs() {
        return Stream.of(
                ...
                // volcengine helm chart repository does not exist
                Arguments.of(TEST_VOLCENGINE_HELM_CHART_REPOSITORY_NOT_FOUND,
                             HttpStatus.NOT_FOUND)
        );
    }
