...
class FunctionDeploymentWithArtifactoryRegistryTest {
    ...
    void beforeAll() {
        ...
        var addRegistryCredentialRequestForArtifactory = AddRegistryCredentialRequest.builder()
        ...
        registryCredentialService.addRegistryCredential(
                ...
                addRegistryCredentialRequestForArtifactory, ProvisionedByEnum.USER,
