...
class PatchAuthorizedPartiesTest {
    @Autowired
    ...
    Stream<Arguments> patchAuthorizedPartiesArgs() {
        ...
        var validAuthParty2 = AuthorizedPartyDto.builder().ncaId(TEST_AUTHORIZED_NCA_ID_4).build();
        ...
        var jwtCases = Stream.of(
                ...
                Arguments.of(MOCK_OAUTH2_TOKEN_SERVER.getJwt(TEST_CLIENT_SUBJECT,
                             ...
                             TEST_VERSION_ID_1,
                             HttpStatus.BAD_REQUEST),
                Arguments.of(null, validAuthParty1,
        ...
        var apiKeyCases = Stream.of(
                ...
                Arguments.of((Supplier<String>) () -> {
                             ...
                             TEST_VERSION_ID_1,
                             HttpStatus.FORBIDDEN),
                Arguments.of("nvapi-stg-some-key", validAuthParty1,
                             TEST_FUNCTION_ID, TEST_VERSION_ID_1, HttpStatus.FORBIDDEN),
                Arguments.of("nvapi-stg-some-key", validAuthParty1,
                             TEST_FUNCTION_ID_2, TEST_VERSION_ID_1, HttpStatus.FORBIDDEN)
        );
    ...
    Stream<Arguments> addExistingAuthorizedPartiesArgs() {
        var existingAuthParty = AuthorizedPartyDto.builder()
                .ncaId(TEST_AUTHORIZED_NCA_ID_2)
                .build();
    ...
    void addAuthorizedPartyToFunction(
            Object tokenSupplier, AuthorizedPartyDto authorizedParty,
        ...
        var requestEntity =
                RequestEntity
                        .patch(URI.create("/v2/nvcf/authorizations/functions/" + functionId + "/add"))
    ...
    void addAuthorizedPartyToFunctionVersion(
        ...
        var requestEntity =
                RequestEntity
                        .patch(URI.create("/v2/nvcf/authorizations/functions/" + functionId
        ...
        assertThat(responseBody.function().ncaId()).isEqualTo(TEST_NCA_ID);
        assertThat(responseBody.function().authorizedParties()).hasSize(expectedVersionAuthDtos.size());
        responseBody.function().authorizedParties().forEach(dto -> {
    ...
    void removeAuthorizedPartyFromFunction(
        ...
        var requestEntity =
                RequestEntity
                        .patch(URI.create("/v2/nvcf/authorizations/functions/" + functionId + "/remove"))
                        .header("Authorization", "Bearer " + token)
                        .body(requestBody);
        var responseEntity =
                testRestTemplate.exchange(requestEntity, AuthorizedPartiesResponse.class);
        ...
        assertThat(responseBody.function().authorizedParties())
                .hasSize(expectedFunctionAuthDtos.size());
        responseBody.function().authorizedParties()
                .forEach(dto -> assertThat(dto).isIn(expectedFunctionAuthDtos));
    ...
    void removeAuthorizedPartyFromFunctionVersion(
        ...
        responseBody.function().authorizedParties().
                forEach(dto -> assertThat(dto).isIn(expectedVersionAuthDtos));
