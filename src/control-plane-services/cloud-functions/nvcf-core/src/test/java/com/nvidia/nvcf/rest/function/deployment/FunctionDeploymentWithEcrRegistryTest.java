...
class FunctionDeploymentWithEcrRegistryTest {
    ...
    void beforeAll() {
        ...
        var addRegistryCredentialRequestForEcr = AddRegistryCredentialRequest.builder()
                ...
                .build();
        var addRegistryCredentialRequestForEcrPublic = AddRegistryCredentialRequest.builder()
        ...
        registryCredentialService.addRegistryCredential(
                ...
                addRegistryCredentialRequestForEcr, ProvisionedByEnum.USER,
                testCommonService.getAuditEventPayloadBuilder());
        registryCredentialService.addRegistryCredential(
                TEST_NCA_ID, accountEntity,
                addRegistryCredentialRequestForEcrPublic, ProvisionedByEnum.USER,
                testCommonService.getAuditEventPayloadBuilder());
    }
