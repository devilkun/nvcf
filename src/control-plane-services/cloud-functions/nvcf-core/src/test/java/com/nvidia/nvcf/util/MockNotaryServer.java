...
import static com.nvidia.nvcf.util.NotaryServiceResponseTransformer.NAME;
...
public class MockNotaryServer {
    ...
    @SneakyThrows
    public static void start(String notaryBaseUrl,
        ...
        mockNotaryServer.stubFor(get(urlPathEqualTo("/.well-known/jwks.json"))
