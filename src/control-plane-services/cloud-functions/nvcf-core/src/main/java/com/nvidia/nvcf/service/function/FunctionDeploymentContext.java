...
/**
 * Holds a deployment entity and GPU specification entities from the gpu_specifications table.
 */
public record FunctionDeploymentContext(
        @NotNull
        FunctionDeploymentEntity deployment,
        @NotNull
        List<GpuSpecificationEntity> gpuSpecs) {
}
