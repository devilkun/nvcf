...
@Tag(name = "Cross-Account Registry Credential Management For NVIDIA Super Admins",
        description = """
                Defines Registry Credential Management endpoints for NVIDIA Super Admins to
                 work across accounts. All the endpoints can only be invoked with a bearer
                 token in HTTP Authorization header with 'admin:manage_registry_credentials' scope.
                """
)
public class XAccountRegistryCredentialManagementController {
    private static final String AUTH_DESCRIPTION = """
            Requires a bearer token in the HTTP Authorization header with
             'admin:manage_registry_credentials' scope. These endpoints are invoked by
    ...
    @PostMapping(value = {"registry-credentials"}, consumes = APPLICATION_JSON_VALUE)
    @Operation(
            summary = "Add new registry credential to the account",
            description = """
                    Adds a new registry credential to the account.
                    """ + AUTH_DESCRIPTION)
    @PreAuthorize("hasAuthority('admin:manage_registry_credentials')")
    ...
    @GetMapping("registry-credentials")
    @Operation(
    ...
    @GetMapping("registry-credentials/{registryCredentialId}")
    @Operation(
    ...
    @PatchMapping(value = {"registry-credentials/{registryCredentialId}"},
    ...
    @DeleteMapping("registry-credentials/{registryCredentialId}")
    @Operation(
            summary = "Delete Registry Credential",
            description = """
                    Deletes the specified registry credential associated with the specified
                     NVIDIA Cloud Account.
                    """ + AUTH_DESCRIPTION,
    ...
    @GetMapping("recognized-registries")
    @Operation(
