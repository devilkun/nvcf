...
@PrimaryKeyClass
public class TelemetryByAccountKey implements Serializable {

    public static final String COLUMN_NCA_ID = "nca_id";
    public static final String COLUMN_TELEMETRY_ID = "telemetry_id";
    ...
    @NonNull
    @PrimaryKeyColumn(name = COLUMN_TELEMETRY_ID, ordinal = 1, type = PrimaryKeyType.CLUSTERED)
