...
@Builder
@Schema(description = "Data Transfer Object(DTO) representing a request queue for function version")
public record QueueDto(
        ...
        @Schema(description = "Approximate number of messages in the request queue")
        int queueDepth) {
}
