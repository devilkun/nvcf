...
// func NewDeploymentStats(functionVersionId uuid.UUID, pending int, pendingError int, building int, buildingError int, downloadingModel int, downloadingModelError int, downloadingContainer int, downloadingContainerError int, initializingContainer int, initializingContainerError int, ready int,  active int, requestingTermination int, destroyed int) DeploymentStats {
func NewDeploymentStats(functionVersionId uuid.UUID, pending int, pendingError int, building int, buildingError int, downloadingModel int, downloadingModelError int, downloadingContainer int, downloadingContainerError int, initializingContainer int, initializingContainerError int, ready int, requestingTermination int, destroyed int) DeploymentStats {
...
func NewStageTransitionEvent(ncaId string, functionId uuid.UUID, functionVersionId uuid.UUID, instanceId string, event string, eventType string, timestamp time.Time, details json.RawMessage) (StageTransitionEvent, error) {
...
func NewDeploymentStageTransitionEvent(ncaId string, functionId, functionVersionId, deploymentId uuid.UUID, instanceId, event, eventType string, timestamp time.Time, details json.RawMessage) (DeploymentStageTransitionEvent, error) {
...
func NewInstance(instanceId string, lastEvent string, lastEventDetails json.RawMessage, lastEventTimestamp time.Time, deployStartTimestamp time.Time, instanceType string) Instance {
	return Instance{
		InstanceId:           instanceId,
		LastEvent:            lastEvent,
