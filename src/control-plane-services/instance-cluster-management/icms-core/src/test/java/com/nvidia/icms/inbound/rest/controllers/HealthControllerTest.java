...
class HealthControllerTest extends IntegrationTest {
    ...
    @Test
    void getLegacyHealth_withNoAuthToken_returnsSuccess()
            throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(LEGACY_HEALTH_ENDPOINT)
                                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(MockMvcResultMatchers.status().isOk());
    }

    @Test
    void getHealth_withNoAuthToken_returnsSuccess()
            throws Exception {
