...
@Repository
public interface ClustersByAuthorizedAccountsRepo extends
        CassandraRepository<ClustersByAuthorizedAccountsEntity, ClustersByAuthorizedAccountsKey>,
        IcmsDatabaseRepository<ClustersByAuthorizedAccountsEntity> {

    List<ClustersByAuthorizedAccountsEntity> findAllByKeyNcaIdKey(String ncaIdKey);
}
