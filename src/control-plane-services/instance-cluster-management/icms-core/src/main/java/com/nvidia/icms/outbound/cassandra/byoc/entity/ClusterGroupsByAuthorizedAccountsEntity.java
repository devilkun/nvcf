...
@Table(ClusterGroupsByAuthorizedAccountsEntity.TABLE_NAME)
public class ClusterGroupsByAuthorizedAccountsEntity {

    public static final String TABLE_NAME = "cluster_groups_by_authorized_accounts";
    ...
    @PrimaryKey
    @NotNull
    ClusterGroupsByAuthorizedAccountsKey key;
    ...
    public String getClusterGroupName() {
        return getKey().getClusterGroupName();
    }
