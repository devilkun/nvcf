...
@Repository
public interface ClusterByGroupIdAndIdRepo extends
        CassandraRepository<ClusterByGroupIdAndIdEntity, ClusterByGroupIdAndIdKey>,
        IcmsDatabaseRepository<ClusterByGroupIdAndIdEntity> {

    List<ClusterByGroupIdAndIdEntity> findByKeyClusterGroupId(String clusterGroupId);
}
