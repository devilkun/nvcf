...
@UserDefinedType(InstanceTypeV5Udt.UDT_NAME_INSTANCE_TYPE_V5)
@AllArgsConstructor
@NoArgsConstructor
@Builder
@Data
/*
 InstanceTypeV5Udt will be used in GpuV5Udt
 */
public class InstanceTypeV5Udt implements Serializable {

    public static final String UDT_NAME_INSTANCE_TYPE_V5 = "instancetypev5";
    ...
    public static final String INSTANCE_TYPE_USAGE = "instance_type_usage";
    ...
    /*
    In the DB the column name is instance_type_usage, we will be storing NodeTypeEnum value in it
    hence the variable name is nodeType
    When we define instancetypev6 then we will update field name to node_type in DB
     */
    @Column(INSTANCE_TYPE_USAGE)
    String nodeType;

    
    /**
     * Copy constructor that creates a deep copy of the provided InstanceTypeV5Udt
     * @param other the InstanceTypeV5Udt to copy from
     */
    public InstanceTypeV5Udt(InstanceTypeV5Udt other) {
        if (other != null) {
            this.cpuCores = other.cpuCores;
            this.systemMemory = other.systemMemory;
            this.gpuMemory = other.gpuMemory;
            this.gpuCount = other.gpuCount;
