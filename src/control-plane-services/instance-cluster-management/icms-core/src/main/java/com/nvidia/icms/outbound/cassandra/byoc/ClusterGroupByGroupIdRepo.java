...
@Repository
public interface ClusterGroupByGroupIdRepo extends
        CassandraRepository<ClusterGroupByGroupIdEntity, String>,
        IcmsDatabaseRepository<ClusterGroupByGroupIdEntity> {
