...
@Slf4j
public class NoOpClusterRegistrationHandler implements ClusterRegistrationHandler {

    @Override
    public void registerCluster(
            ClusterRegistrationRequest registrationRequest,
            String zoneName,
            String clientId,
            Map<String, Object> auditProps) {
        log.debug("NoOpClusterRegistrationHandler.registerCluster called — no-op");
    }
}
