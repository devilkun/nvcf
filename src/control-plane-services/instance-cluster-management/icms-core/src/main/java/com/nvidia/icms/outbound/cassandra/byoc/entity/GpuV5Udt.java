...
@UserDefinedType(GpuV5Udt.UDT_NAME_GPUS_V5)
@AllArgsConstructor
@NoArgsConstructor
@Builder
@Data
public class GpuV5Udt  implements Serializable {
    public static final String UDT_NAME_GPUS_V5 = "gpusv5";
    ...
    public Set<InstanceTypeV5Udt> getInstanceTypes() {
