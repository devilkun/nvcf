...
@AllArgsConstructor
@NoArgsConstructor
public class InstanceLaunchSpecification {
    ...
    @JsonProperty("NcaId")
    @Schema(description = "Id of the cloud account for which " +
    ...
    public static class Placement {
        ...
        @Schema(description = "Request availability zone for the instances")
