...
@Repository
public interface FunctionBillingMappingRepo extends
        CassandraRepository<FunctionBillingMappingEntity, FunctionBillingMappingKey>,
        IcmsDatabaseRepository<FunctionBillingMappingEntity> {

    Optional<FunctionBillingMappingEntity> findByKeyFunctionIdAndKeyFunctionVersionId(
