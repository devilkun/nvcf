...
@Table(ClusterGroupsByAccountEntity.TABLE_NAME)
public class ClusterGroupsByAccountEntity {

    public static final String TABLE_NAME = "cluster_groups_by_account";
    ...
    @NonNull
    @PrimaryKey
    private ClusterGroupsByAccountKey key;
