...
@Repository
public interface ClusterConfigurationByClusterIdRepo extends
        CassandraRepository<ClusterConfigurationByClusterIdEntity, String>,
        IcmsDatabaseRepository<ClusterConfigurationByClusterIdEntity> {
