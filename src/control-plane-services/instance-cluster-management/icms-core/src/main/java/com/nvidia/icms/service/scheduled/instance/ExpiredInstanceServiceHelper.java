...
@Component
@AllArgsConstructor
public class ExpiredInstanceServiceHelper {

    public static final String INSTANCE_LIFETIME_EXPIRED_ERROR_LOG = "Instance lifetime expired";

    private final InstanceServiceHelper instanceServiceHelper;
    private final AppAuditService auditService;

    public GenericMetric buildExpiredInstanceTerminationMetric(
    ...
    public void sendAuditForExpiredInstance(
        ...
        auditProps.put(AUDIT_SUMMARY_KEY,
                "Terminated lifetime expired instance " + updatedInstance.getInstanceId());
