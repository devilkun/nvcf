...
public class JwtConfiguration {
    ...
    public PrivateJwksString privateJwks() {
        return new PrivateJwksString(nakProperties.getJwks().getPrivateJwks());
    }

    @Bean
    public JweKeysMapping getJweKeysMapping() {
        return JweKeysMapping.builder()
                .keysMapping(nakProperties.getJwks().getJweKeyMapping())
                .build();
    }

    @Bean
    public EncryptedModelConverterProperties encryptedModelConverterProperties() {
        return nakProperties.getEncryptedModelConverter();
    }
}
