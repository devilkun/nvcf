...
class TaskCreationWithHarborRegistryTest {
    ...
    @Value("${nvct.registries.recognized.container.harbor.oauth2.base-url}")
    private String harborAuthBaseUrl;

    MockOciRegistryServer mockHarborRegistryServer;
    ...
    Stream<Arguments> createTaskWithHelmChartArgs() {
        return Stream.of(
                ...
                // harbor helm chart tag does not exist
                Arguments.of(TEST_HARBOR_HELM_CHART_NOT_EXISTS, HttpStatus.NOT_FOUND),
                // harbor helm chart mismatch with secret
