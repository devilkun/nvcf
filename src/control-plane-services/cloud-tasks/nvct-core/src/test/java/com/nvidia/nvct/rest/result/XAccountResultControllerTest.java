...
class XAccountResultControllerTest {
    ...
    void beforeEach() {
        ...
        var otherMetadata1 = metadataTemplate.formatted(3000, 0.4, 0.5, 3000);
    ...
    void shouldListResults(Object tokenSupplier,
        ...
        var uri = URI.create("/v1/nvct/accounts/" + ncaId + "/tasks/" + taskId + "/results");
        var requestEntity =
        ...
        for (var resultDto : responseBody.results()) {
            ...
            assertThat(resultDto.metadata()).hasSize(4);
    ...
    void shouldListResultsWithPaginationLimit(String token,
        ...
        var requestEntity = RequestEntity
                .get(URI.create("/v1/nvct/accounts/" + ncaId +
                                        "/tasks/" + taskId + "/results?limit=" + limit))
                .header("Authorization", "Bearer " + token)
                .build();
        var responseEntity = testRestTemplate.exchange(requestEntity, ListResultsResponse.class);
    ...
    void shouldListResultsWithPaginationCursor() {
        ...
        var url = "/v1/nvct/accounts/" + TEST_NCA_ID + "/tasks/" + TEST_TASK_ID_1 + "/results?limit=2";
        var requestEntity = RequestEntity
                .get(URI.create(url))
                .header("Authorization", "Bearer " + token)
                .build();
        ...
        url = "/v1/nvct/accounts/" + TEST_NCA_ID + "/tasks/" + TEST_TASK_ID_1
                + "/results?limit=2&cursor=" + currentCursor;
        requestEntity =
