...
class XAccountTaskWithTelemetriesTest {
    @Autowired
    ...
    Stream<Arguments> createTaskWithTelemetriesArgs() {
        ...
        var validPartialTelemetriesDto = TelemetriesDto.builder()
                .logsTelemetryId(TEST_TELEMETRY_LOGS_ID)
                .build();
        var mismatchedTelemetriesDto = TelemetriesDto.builder()
                ...
                .build();
        var mismatchedPartialTelemetriesDto = TelemetriesDto.builder()
                .logsTelemetryId(TEST_TELEMETRY_TRACES_ID)
                .build();

        return Stream.of(
                // Valid telemetries from correct parent account.
                ...
                Arguments.of(MOCK_OAUTH2_TOKEN_SERVER.getJwt(TEST_ADMIN_SUBJECT,
                             ...
                             null,
                             HttpStatus.OK),
                // Valid telemetries but not the correct account.
                Arguments.of(MOCK_OAUTH2_TOKEN_SERVER.getJwt(TEST_ADMIN_SUBJECT,
                                                             List.of(ADMIN_SCOPE_LAUNCH_TASK,
                                                          ADMIN_SCOPE_LIST_TASKS),
                                                             100),
                ...
                // Mismatched telemetries from the correct parent account.
                Arguments.of(MOCK_OAUTH2_TOKEN_SERVER.getJwt(TEST_ADMIN_SUBJECT,
                                                             List.of(ADMIN_SCOPE_LAUNCH_TASK,
                                                          ADMIN_SCOPE_LIST_TASKS),
                                                             100),
                             TEST_NCA_ID_WITH_TELEMETRIES_4,
                             mismatchedTelemetriesDto,
                             null,
                             null,
                             null,
                             HttpStatus.BAD_REQUEST),
                ...
                Arguments.of(MOCK_OAUTH2_TOKEN_SERVER.getJwt(TEST_ADMIN_SUBJECT,
                                                          ...
                                                          ADMIN_SCOPE_LIST_TASKS),
                                                             100),
                             TEST_NCA_ID_WITH_TELEMETRIES_4,
                             mismatchedPartialTelemetriesDto,
                             null,
                             null,
                             null,
                             HttpStatus.BAD_REQUEST)
    ...
    void shouldCreateTaskWithTelemetries(
        ...
        assertThat(responseBody.task().containerEnvironment()).isEqualTo(TEST_CONTAINER_ENVIRONMENT);
    ...
    void shouldListTasksWithTelemetries() {
        ...
        var token = MOCK_OAUTH2_TOKEN_SERVER.getJwt(TEST_ADMIN_SUBJECT,
                                                    ...
                                                    100);
        var uri = URI.create("/v1/nvct/accounts/" + TEST_NCA_ID_WITH_TELEMETRIES_4 + "/tasks");
    ...
    void shouldGetTaskDetailsWithTelemetries() {
        ...
        var token = MOCK_OAUTH2_TOKEN_SERVER.getJwt(TEST_ADMIN_SUBJECT,
                                                    ...
                                                    100);
        var uri = URI.create("/v1/nvct/accounts/" + TEST_NCA_ID_WITH_TELEMETRIES_4
                                     + "/tasks/" + TEST_TASK_ID_1);
        var requestEntity = RequestEntity.get(uri)
                .header("Authorization", "Bearer " + token)
                .build();
        var responseEntity =
