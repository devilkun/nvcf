...
class TaskCreationWithAcrRegistryTest {
    ...
    @Value("${nvct.registries.recognized.container.acr.oauth2.base-url}")
    ...
    Stream<Arguments> CreateTaskWithContainerImageArgs() {
        return Stream.of(
                ...
                Arguments.of(TEST_ACR_CONTAINER_IMAGE_WITH_TAG, HttpStatus.OK),
                // acr container image with digest
                Arguments.of(TEST_ACR_CONTAINER_IMAGE_WITH_DIGEST, HttpStatus.OK),
                // acr container image does not exist
                Arguments.of(TEST_ACR_CONTAINER_IMAGE_NOT_EXISTS, HttpStatus.NOT_FOUND),
                // acr container image no permission
                Arguments.of(TEST_ACR_CONTAINER_IMAGE_PERMISSION_DENIED, HttpStatus.FORBIDDEN)
        );
    }
    ...
    Stream<Arguments> CreateTaskWithHelmChartArgs() {
        return Stream.of(
                ...
                Arguments.of(TEST_ACR_HELM_CHART_WITH_TAG, HttpStatus.OK),
                // acr helm chart with digest
                Arguments.of(TEST_ACR_HELM_CHART_WITH_DIGEST, HttpStatus.OK),
                // acr helm chart does not exist
                Arguments.of(TEST_ACR_HELM_CHART_NOT_EXISTS, HttpStatus.NOT_FOUND),
                // acr helm chart no permission
                Arguments.of(TEST_ACR_HELM_CHART_PERMISSION_DENIED, HttpStatus.FORBIDDEN)
        );
    }
