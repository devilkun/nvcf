...
class XAccountTaskWithHelmValidationPolicyTest {
    @Autowired
    ...
    void shouldCreateTaskWithHelmValidationPolicy(
        ...
        var requestEntity = RequestEntity
                .post(URI.create("/v1/nvct/accounts/" + TEST_NCA_ID + "/tasks"))
    ...
    void shouldListTasksWithHelmValidationPolicy() {
        ...
        var requestBody = CreateTaskRequest.builder()
                ...
                .secrets(TEST_SECRETS)
                .build();
        var createEntity = RequestEntity
                .post(URI.create("/v1/nvct/accounts/" + TEST_NCA_ID + "/tasks"))
                .contentType(MediaType.APPLICATION_JSON)
                .header("Authorization", "Bearer " + token)
                .body(requestBody);
        ...
        var listEntity = RequestEntity
                .get(URI.create("/v1/nvct/accounts/" + TEST_NCA_ID + "/tasks"))
                .header("Authorization", "Bearer " + token)
                .build();
        var listResponse =
    ...
    void shouldGetTaskDetailsWithHelmValidationPolicy() {
        ...
        var getEntity = RequestEntity
                .get(URI.create("/v1/nvct/accounts/" + TEST_NCA_ID
                                        + "/tasks/" + taskId))
                .header("Authorization", "Bearer " + token)
                .build();
        var getResponse =
