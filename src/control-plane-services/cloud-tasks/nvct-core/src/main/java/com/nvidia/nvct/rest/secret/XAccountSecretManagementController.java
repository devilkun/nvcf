...
@RequestMapping(value = "/v1/nvct/accounts/{ncaId}/secrets/", produces = APPLICATION_JSON_VALUE)
@Tag(name = "Cross-Account User Secret Management for NVIDIA Super Admins",
        description = """
                Defines User Secret Management endpoints for NVIDIA Super Admins to work across
...
public class XAccountSecretManagementController {
    ...
    private final com.nvidia.nvct.service.account.AccountService accountService;
    ...
    @Operation(
            ...
            description = """
                    Updates secrets for the specified task id. This endpoint requires a bearer
                     token with 'admin:update_secrets' scope in the HTTP Authorization header.
                    """,
