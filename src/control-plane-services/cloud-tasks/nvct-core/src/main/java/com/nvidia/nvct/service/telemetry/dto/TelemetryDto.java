...
@Builder
@Schema(description = "Data Transfer Object (DTO) for Telemetry configurations")
public record TelemetryDto(

        @Schema(description = "Unique telemetry ID")
        @NotNull UUID telemetryId,

        @Schema(description = "Telemetry name")
        @NotBlank String name,

        @Schema(description = "URL for the telemetry endpoint")
        ...
        @Schema(description = "Telemetry creation timestamp")
