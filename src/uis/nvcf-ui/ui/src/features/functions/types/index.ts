...
import type { FunctionDeploymentDto } from "~/generated/model/functionDeploymentDto";
...
export type FunctionWithDeployment = FunctionDto & {
	deploymentSpecifications: GpuSpecificationDto[];
	lastUpdatedAt: FunctionDeploymentDto["lastUpdatedAt"];
};
