...
@ActiveProfiles("test")
class AbsolutePathIntegrationTest extends PathIntegrationTest {

    @BeforeAll
    static void init() {
        var absolutePath = new File("src/test/resources/kv_secret_example.json")
                .getAbsolutePath();
        System.setProperty(ENABLED, "true");
        System.setProperty(FILE, "file:" + absolutePath);
