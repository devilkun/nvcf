...
/**
 * Verifies that when the properties file is on classpath and also accessible as a
 * physical file (e.g. from src/test/resources), properties are loaded and
 * FileBasedPropertiesRefresher starts polling.
 */
@SpringBootTest(classes = TestApplication.class)
@ActiveProfiles("test")
class ClasspathAndFileIntegrationTest extends PathIntegrationTest {

    @org.junit.jupiter.api.BeforeAll
    static void init() {
        System.setProperty(ENABLED, "true");
        System.setProperty(FILE, "classpath:kv_secret_example.json");
