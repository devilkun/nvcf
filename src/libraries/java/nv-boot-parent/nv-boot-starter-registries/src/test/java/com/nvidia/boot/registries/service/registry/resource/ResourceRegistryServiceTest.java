...
import static com.nvidia.boot.registries.util.TestConstants.MOCK_NGC_RESOURCE_REGISTRY_CRED;
...
import static com.nvidia.boot.registries.util.TestConstants.TEST_NGC_RESOURCE_URL;
import static com.nvidia.boot.registries.util.TestConstants.TEST_NGC_RESOURCE_URL_MISSING_PROTOCOL_1;
import static com.nvidia.boot.registries.util.TestConstants.TEST_NGC_RESOURCE_URL_NOT_EXISTS_1;
import static com.nvidia.boot.registries.util.TestConstants.TEST_NGC_RESOURCE_URL_PERMISSION_DENIED_REGISTRY_1;
import static com.nvidia.boot.registries.util.TestConstants.TEST_NGC_RESOURCE_URL_UNKNOWN_REGISTRY_1;
import static com.nvidia.boot.registries.util.TestConstants.TEST_NGC_RESOURCE_URL_WITH_CANARY_HOST;
...
import static com.nvidia.boot.registries.util.TestConstants.TEST_RESOURCE_URL_1;
...
import com.nvidia.boot.registries.util.TestConstants;
...
class ResourceRegistryServiceTest {

    private static ResourceRegistryService resourceRegistryService;
    ...
    static void beforeAll() {
        ...
        NgcResourceRegistry ngcResourceRegistry =
                new NgcResourceRegistry(ngcArtifactRegistryClient);
        ...
        resourceRegistryService = new ResourceRegistryService(List.of(ngcResourceRegistry),
        ...
        resourceRegistryService.overwriteRegistryHostnameMap(
                ...
                TestConstants.TEST_NGC_ARTIFACT_REGISTRY);
    }
    ...
    static Stream<Arguments> getValidResourceUrls() {
        var ngcArtifactList =
                List.of(new Artifact("test1", "v1", ArtifactTypeEnum.RESOURCE, List.of(
                        new ArtifactFile("/image1", "https://api.stg.ngc.nvidia.com/image1"),
                        new ArtifactFile("/image2", "https://api.stg.ngc.nvidia.com/image2"))));
        var ngcArtifactSize = 69753543449L;
        return Stream.of(
                Arguments.of(List.of(new ArtifactDetails(
                                     "test1", "v1", TEST_NGC_RESOURCE_URL)),
                             MOCK_NGC_RESOURCE_REGISTRY_CRED, ngcArtifactSize,
                             ngcArtifactList),
                Arguments.of(List.of(new ArtifactDetails(
                                     "test1", "v1", TEST_NGC_RESOURCE_URL_WITH_CANARY_HOST)),
                             MOCK_NGC_RESOURCE_REGISTRY_CRED, ngcArtifactSize,
                             ngcArtifactList));
    }

    @ParameterizedTest
    @MethodSource("getValidResourceUrls")
    void validateArtifact_Success(List<ArtifactDetails> artifacts, String apiKey) {
        resourceRegistryService.validateArtifacts(artifacts,
                                                  Map.of(TestConstants.TEST_NGC_ARTIFACT_REGISTRY,
                                                         List.of(apiKey),
    ...
    void fetchSize_Success(List<ArtifactDetails> artifacts, String apiKey, long expectedSize) {
        var size = resourceRegistryService.fetchSize(artifacts,
    ...
    void fetchArtifact_Success(List<ArtifactDetails> artifacts, String apiKey, long expectedSize,
        ...
        var artifactList = resourceRegistryService.fetchArtifact(artifacts,
                                                                 Map.of(TEST_NGC_ARTIFACT_REGISTRY,
                                                                        List.of(apiKey),
                                                                        TEST_NGC_ARTIFACT_REGISTRY_PROD,
                                                                        List.of(apiKey)));
    ...
    static Stream<Arguments> getInvalidResourceUrls() {
        return Stream.of(
                ...
                Arguments.of(List.of(new ArtifactDetails("test1", "v1",
                             ...
                             BadRequestException.class),
                Arguments.of(List.of(new ArtifactDetails("test1", "v1",
                                                         TEST_NGC_RESOURCE_URL_NOT_EXISTS_1)),
                             Map.of(TestConstants.TEST_NGC_ARTIFACT_REGISTRY,
                                    List.of(MOCK_NGC_RESOURCE_REGISTRY_CRED)),
                ...
                Arguments.of(List.of(new ArtifactDetails("test1", "v1", TEST_NGC_RESOURCE_URL)),
                             Map.of(),
                             BadRequestException.class));
    }

    @ParameterizedTest
    @MethodSource("getInvalidResourceUrls")
    void validateArtifact_Fail(List<ArtifactDetails> artifacts,
        ...
        assertThrows(expectedException,
                     () -> resourceRegistryService.validateArtifacts(artifacts, credentials));
    }
    ...
    void fetchSize_Fail(List<ArtifactDetails> artifacts,
                        ...
                        Class<Throwable> expectedException) {
        assertThrows(expectedException,
                     () -> resourceRegistryService.fetchSize(artifacts, credentials));
    }
    ...
    void fetchArtifact_Fail(List<ArtifactDetails> artifacts,
                            ...
                            Class<Throwable> expectedException) {
        assertThrows(expectedException,
                     () -> resourceRegistryService.fetchArtifact(artifacts, credentials));
    }
    ...
    void validateArtifacts_ArtifactValidationDisabled_SkipsValidation() {
        ...
        assertDoesNotThrow(() -> service.validateArtifacts(
                List.of(new ArtifactDetails("n", "v", TEST_RESOURCE_URL_1)), Map.of()));
    }

    private static ResourceRegistryService createServiceWithArtifactValidationDisabled() {
        ...
        recognizedRegistryConfig.setResource(Map.of(
                ...
                TestUtils.registryConfig(TEST_RESOURCE_REGISTRY_HOST_NAME_1, true, false)));
        ...
        return new ResourceRegistryService(List.of(), mapperService, validationService);
    }
}
