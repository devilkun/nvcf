...
package com.nvidia.boot.registries.service.registry.container.artifactory;
...
public class ArtifactoryContainerRegistry implements ContainerRegistry {
    ...
    public void validateArtifact(String containerImageUrl, String secret) {
        artifactoryClient.validateArtifact(containerImageUrl, secret);
    }
