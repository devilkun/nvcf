...
package com.nvidia.boot.registries.service.registry.container.ecr.pub;
...
public class EcrPublicContainerRegistry implements ContainerRegistry {

    private final EcrPublicContainerRegistryClient ecrPublicContainerRegistryClient;
    ...
    public String getHostname() {
        return ecrPublicContainerRegistryClient.getHostname();
    }

    @Override
    public void validateArtifact(String containerImageUrl, String secret) {
        ecrPublicContainerRegistryClient.validateContainerImage(containerImageUrl, secret);
    }

    @Override
    public void validateCredential(String hostname, String secret) {
        ecrPublicContainerRegistryClient.validateCredential(hostname, secret);
    }
