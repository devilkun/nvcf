...
package com.nvidia.boot.registries.service.registry.container.ngc;
...
@Slf4j
public class NgcContainerRegistry implements ContainerRegistry {
    private final NgcContainerRegistryClient ngcContainerRegistryClient;
    ...
    public String getHostname() {
        return ngcContainerRegistryClient.getHostname();
    }

    @Override
    public void validateArtifact(String containerImageUrl, String secret) {
        ngcContainerRegistryClient.validateContainerImage(containerImageUrl, secret);
    }

    @Override
    public void validateCredential(String hostname, String secret) {
        ngcContainerRegistryClient.validateCredential(hostname, secret);
    }
