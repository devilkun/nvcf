...
package com.nvidia.boot.registries.service.registry.helm.ecr.pvt;
...
@Slf4j
public class EcrPrivateHelmRegistry implements HelmRegistry {

    private final EcrPrivateArtifactRegistryClient ecrPrivateArtifactRegistryClient;
    ...
    public String getHostname() {
        return ecrPrivateArtifactRegistryClient.getHostname();
    }

    @Override
    public void validateArtifact(String helmChartUrl, String secret) {
        ecrPrivateArtifactRegistryClient.validateHelmChart(helmChartUrl, secret);
    }

    @Override
    public void validateCredential(String hostname, String secret) {
        ecrPrivateArtifactRegistryClient.validateCredential(hostname, secret);
    }
