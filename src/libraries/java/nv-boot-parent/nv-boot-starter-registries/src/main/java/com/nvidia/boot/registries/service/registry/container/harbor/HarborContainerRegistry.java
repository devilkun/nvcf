...
package com.nvidia.boot.registries.service.registry.container.harbor;
...
public class HarborContainerRegistry implements ContainerRegistry {
    ...
    public void validateArtifact(String containerImageUrl, String secret) {
        harborRegistryClient.validateArtifact(containerImageUrl, secret);
    }
