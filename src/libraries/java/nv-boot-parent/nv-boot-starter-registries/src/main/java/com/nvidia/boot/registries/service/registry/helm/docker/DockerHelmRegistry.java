...
package com.nvidia.boot.registries.service.registry.helm.docker;
...
@Slf4j
public class DockerHelmRegistry implements HelmRegistry {
    private final DockerRegistryClient dockerClient;
    ...
    public String getHostname() {
        return dockerClient.getHostname();
    }

    @Override
    public void validateArtifact(String helmChartUrl, String secret) {
        dockerClient.validateImage(helmChartUrl, secret);
    }

    @Override
    public void validateCredential(String hostname, String secret) {
        dockerClient.validateCredential(hostname, secret);
    }

    @Override
    public void invalidateCache() {
        dockerClient.resetAuthTokenCache();
    }
}
