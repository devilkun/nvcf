...
public interface ResourceRegistry {
    ...
    long fetchSize(ArtifactDetails artifact, String secret);

    Artifact fetchArtifact(ArtifactDetails artifact, String secret);

    void validateArtifact(ArtifactDetails artifact, String secret) throws BadRequestException,
