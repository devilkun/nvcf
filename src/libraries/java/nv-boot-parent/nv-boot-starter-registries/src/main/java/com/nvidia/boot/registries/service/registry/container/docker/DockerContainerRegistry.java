...
package com.nvidia.boot.registries.service.registry.container.docker;
...
@Slf4j
public class DockerContainerRegistry implements ContainerRegistry {
    ...
    public String getHostname() {
        return dockerRegistryClient.getHostname();
    }

    @Override
    public void validateArtifact(String containerImageUrl, String secret) {
        dockerRegistryClient.validateImage(containerImageUrl,
                                           secret);
    }

    @Override
    public void validateCredential(String hostname, String secret) {
        dockerRegistryClient.validateCredential(hostname, secret);
    }
