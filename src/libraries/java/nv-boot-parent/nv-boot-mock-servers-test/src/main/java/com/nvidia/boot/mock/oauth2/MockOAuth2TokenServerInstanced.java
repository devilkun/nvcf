...
/**
 * Instanced version of mock OAuth2 token server for integration tests.
 * Each instance has its own WireMock server (unlike the static MockOAuth2TokenServer).
 */
@RequiredArgsConstructor
public class MockOAuth2TokenServerInstanced {
    ...
    public WireMockServer start() {
        ...
        return start(getDefaultStub(jwkSetUriPath));
    }
    ...
    public String getBaseUrl() {
        return wireMockServer != null ? wireMockServer.baseUrl() : null;
    }
