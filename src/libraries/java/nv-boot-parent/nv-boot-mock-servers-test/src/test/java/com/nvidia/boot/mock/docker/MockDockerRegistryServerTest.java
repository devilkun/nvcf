...
import static com.nvidia.boot.mock.TestConstants.MOCK_DOCKER_REGISTRY_URL;
...
class MockDockerRegistryServerTest {
    ...
    void testStartAndStop() {
        ...
        assertDoesNotThrow(() -> MockDockerRegistryServer.stop());
    }
    ...
    void testSetCustomResponse() {
        ...
        assertDoesNotThrow(() -> MockDockerRegistryServer.setResponse(customUrl, customBody));
