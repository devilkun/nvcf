...
{{- define "nvcf-cassandra.fullname" -}}
...
- Bitnami simplified: ["secret1", "secret2"]
- Current format (backward compatibility): [{name: "secret1"}]
*/}}

{{- define "nvcf-cassandra.imagePullSecrets" -}}
  {{- $pullSecrets := list }}
