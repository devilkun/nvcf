#!/bin/bash
#
# FIXED VERSION - For testing purposes
# This version has the corrected zero-padding on line 147
#
...
generate_asymmetric_signing_key() {
    ...
    # FIX: printf %s pads with spaces, so we must replace them with zeros
