...
If you have not set this up yet, follow the [self-hosted-cli](../user/cli.md) guide to
install the binary and the [cli-configuration](../user/cli.md) section to point it at your
gateway.
